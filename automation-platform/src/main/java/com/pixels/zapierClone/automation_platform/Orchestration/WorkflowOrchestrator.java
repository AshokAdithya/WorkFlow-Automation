...
//             .orElseThrow(() -> new RuntimeException("Workflow not found for triggerId: " + triggerId));

//         User user = workflow.getUser();

//         // Step outputs for placeholder resolution
//         Map<String, List<Map<String, String>>> stepOutputs = new HashMap<>();
//         stepOutputs.put("step0", triggerResult.getData());

//         List<WorkflowStep> steps = workflow.getSteps();
//         steps.sort(Comparator.comparingInt(WorkflowStep::getStepOrder)); // Ensure correct order
...
//             try {
//                 rawInputConfig = objectMapper.readValue(
//                     action.getInputConfig(),
//                     new TypeReference<Map<String, Object>>() {}
//                 );
//             } catch (Exception e) {
//                 System.out.println("Failed to parse inputConfig at step" + i);
//                 e.printStackTrace();
//                 continue;
//             }

//             // Resolve placeholders
//             Map<String, Object> resolvedConfig = PlaceholderUtils.resolveMapPlaceholders(rawInputConfig, stepOutputs);

//             try {
//                 List<Map<String, String>> result = handler.executeAction(
//                     def.getActionTypeIdentifier(),
//                     resolvedConfig,
//                     credential
//                 );
//                 stepOutputs.put("step" + i, result != null ? result : new ArrayList<>());
//             } catch (Exception e) {
